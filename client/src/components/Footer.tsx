      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">Learn to create professional video reels with AI tools and CapCut editor.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#process" className="text-gray-400 hover:text-primary transition-colors">Course Curriculum</a></li>
              <li><a href="#tools" className="text-gray-400 hover:text-primary transition-colors">AI Tools</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Free Templates</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Blog & Tutorials</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:support@videoreelsai.com" className="text-gray-400 hover:text-primary transition-colors">
                  support@videoreelsai.com
                </a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-primary" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Creative Studio St.<br/>Digital City, DC 10101</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} VideoReelsAI Masterclass. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
